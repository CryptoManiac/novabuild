...
# 1.env-setup.sh :
#
# Fetches novacoin dependencies once.
#
...
QT_SRC="http://download.qt-project.org/snapshots/qt/5.1/5.1.1/backups/2013-08-25-116/single/qt-everywhere-opensource-src-5.1.1.tar.gz"
